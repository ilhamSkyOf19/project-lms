...
const CardLatestCourse: FC<Props> = ({ data: { id, name, img, category } }) => {
    return (
        <Link to={`/manager/course/manage-course-materi/${id}`} className='w-full h-[6rem] flex flex-row justify-start items-center gap-4 group'>
            {/* course */}
