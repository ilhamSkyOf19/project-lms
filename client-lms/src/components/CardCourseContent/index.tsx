    ...
    return (
        <div className='w-full h-[8rem] flex flex-row justify-start items-center gap-5'>
            ...
            <div className='w-[9.5rem] h-[90%] rounded-3xl bg-primary-black relative overflow-hidden flex flex-col justify-center items-center'>
                ...
                {/* icon */}
                <img src={`/assets/images/icons/${category === 'video' ? 'video-play-white.svg' : 'note-white.svg'}`} alt="icon" className='w-12 rounded-2xl' loading='lazy' />
            </div>
            ...
            <div className='h-full flex flex-col justify-center items-center gap-2'>
                ...
                <div className='w-full flex flex-row justify-start items-start gap-2'>
                    {/* icon */}
                    <img src={`/assets/images/icons/${category === 'video' ? 'video-play-purple.svg' : 'note-purple.svg'}`} alt="icon" className='w-5.5' loading='lazy' />
                    {/* label */}
